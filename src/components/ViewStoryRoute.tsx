      ...
      {story && (
        <>
          ...
          <p>
            ...
            a {story.word3}
            piece of toast, and told me I would never work in the {story.word4}
            business again. I was going to have to wear an "I'm with Stupid"
            novelty T-shirt for
            {story.word5} years. One of these days I'll escape my {story.word3}-
            prison, and I'll be able to tell everyone {story.word6}.
          </p>
        </>
      )}
    </div>
